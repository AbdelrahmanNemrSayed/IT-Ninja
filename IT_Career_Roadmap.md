...
4. **pfSense**: نظام تشغيل جدار حماية (Firewall) وتوجيه شبكات مفتوح المصدر لتأمين وحماية الشبكات المحلية. [تحميل الأداة](https://www.pfsense.org/)
5. **Wazuh Security**: منصة مراقبة أمنية متكاملة (SIEM & XDR) للكشف عن التهديدات وحماية الأنظمة. [تحميل الأداة](https://wazuh.com/)
